...
%function xdot=f(x,t)
% End Octave code
% Species:   id = GLC, name = intracellular glucose,
    const_species_GLC=10.0;
...
% Species:   id = F6P, name = fructose-6-phosphate, involved in a rule
    xdot(2) = x(2);
...
% Species:   id = G3P, name = glyceraldehyde--phosphate, involved in a rule
    xdot(4) = x(4);
	
% Species:   id = DHAP, name = dihydroxyacetone-phosphate, involved in a rule
    xdot(5) = x(5);
